...
#define hd44780_EN_high_delay()     	delay( 0xffff )
#define hd44780_init_delay()        	delay_ms( 45 )
#define hd44780_init_delay2()       	delay_ms( 45 )
#define hd44780_init_delay3()       	delay_ms( 45 )
#define hd44780_init_end_delay()    	delay_ms( 45 )
